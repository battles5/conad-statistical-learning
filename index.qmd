...
## Benvenuti {.benvenuti .divider background-color="#002060" footer=" "}

[Benvenuti al corso di]{.hero-small}

[AI TRADIZIONALE]{.hero-big}

## Benvenuti {.benvenuti .benvenuti-no .divider background-color="#002060" footer=" "}
...
![](img/opera_arte_generata.png){width="56%" fig-alt="Immagine generata da una rete generativa"}
:::
