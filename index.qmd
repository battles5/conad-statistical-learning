...
## La giornata in due tempi {footer="Orso Peruzzi · Apprendimento statistico (CONAD Nord Ovest) · Apertura"}

:::: {.columns}

::: {.column width="50%"}
### Mattina, l'intuizione

- da dove nasce l'idea di "AI tradizionale";
- cos'è davvero l'apprendimento statistico;
- il cuore di tutto: il trade-off bias-varianza;
- le famiglie di modelli e le reti neurali.
:::

::: {.column width="50%"}
### Pomeriggio, le mani sui dati

- code-along guidato su Colab;
- gli stessi concetti, toccati con mano;
- regressione, classificazione, alberi, ensemble;
- un caso retail in stile Conad.
:::

::::

::: {.callout-note appearance="minimal"}
filo rosso: un unico continuum, dai minimi quadrati ai modelli profondi.
:::
